          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-3xl font-bold text-gray-900">
                    {overviewStats.teachingHours}
                  </p>
                  <p className="text-xs text-gray-500 mt-1">
                    +6.5 hours this month
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-md transition-shadow">
                <CardContent className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Badge
                      variant="outline"
                      className="gap-1 text-gray-600 border-gray-200"
                    >
                      0%
                    </Badge>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Teaching and learning sessions by month
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your most active skills and their performance
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <p className="text-gray-600">
                  Detailed teaching metrics and insights coming soon
                </p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="learning">
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <p className="text-gray-600">
                  Detailed learning progress and insights coming soon
                </p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="financial">
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <p className="text-gray-600">
                  Detailed financial reports and insights coming soon
                </p>
              </CardContent>
            </Card>
          </TabsContent>
