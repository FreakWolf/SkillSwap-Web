...
export function PremiumFeatures({ userData, onNavigate }: PremiumFeaturesProps) {
  ...
  const premiumBenefits = [
    {
      ...
      description: 'Crystal clear video quality for the best learning experience'
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="opacity-90">Unlock all premium features with no commitment</p>
                  </div>
                </div>
                <Button 
                  variant="secondary" 
        ...
        {currentPlan === 'free' && (
          <Card className="mb-8">
            <CardHeader>
              ...
              <CardDescription>See how you're using your free plan limits</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span>Sessions this month</span>
                  <span>{usageStats.sessionsUsed} / {usageStats.sessionsLimit}</span>
                </div>
                <Progress value={(usageStats.sessionsUsed / usageStats.sessionsLimit) * 100} />
              </div>
              ...
              <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                <div className="flex items-center space-x-2 text-yellow-800">
                  ...
                  <span className="text-sm">You have {usageStats.sessionsLimit - usageStats.sessionsUsed} sessions remaining this month</span>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="mb-8">
          <CardHeader className="text-center">
            ...
            <CardDescription>Unlock the full potential of your learning journey</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          {Object.entries(plans).map(([planKey, plan]) => (
            <Card 
              key={planKey} 
              className={`relative ${
                plan.hasOwnProperty('popular') && (plan as any).popular ? 'ring-2 ring-blue-500 shadow-lg' : ''
            ...
            >
              ...
              <CardHeader className="text-center">
                <CardTitle className="flex items-center justify-center">
                  {planKey !== 'free' && <Crown className="w-5 h-5 mr-2 text-yellow-500" />}
                  {plan.name}
                </CardTitle>
                ...
                <div className="pt-4">
                  {currentPlan === planKey ? (
                    ...
                    <Button 
                      ...
                      variant={plan.hasOwnProperty('popular') && (plan as any).popular ? 'default' : 'outline'}
                    >
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Your data remains safe. However, some premium features like session recordings beyond the free tier limit may become inaccessible.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Yes! We offer 50% off for students with valid educational email addresses. Contact support to verify your student status.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                We offer a 30-day money-back guarantee for all premium plans. If you're not satisfied, we'll refund your payment in full.
              </p>
            </div>
          </CardContent>
        </Card>
