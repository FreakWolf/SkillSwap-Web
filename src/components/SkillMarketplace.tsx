...
import { Search, Star, MapPin, Clock, Heart, TrendingUp, Users, Award } from 'lucide-react';
...
export function SkillMarketplace({ userData, onNavigate }: SkillMarketplaceProps) {
  ...
  const allSkills = [
    {
      ...
      description: 'Comprehensive JavaScript course covering modern ES6+ features.',
      badge: 'Bestseller'
    },
    {
      id: 2,
    ...
    <div className="h-full overflow-hidden flex flex-col bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-8 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-gray-900">Skill Marketplace</h1>
            <p className="text-sm text-gray-500 mt-1">Find the perfect teacher for your learning journey</p>
          </div>
      ...
      <div className="flex-1 overflow-hidden flex">
        ...
        <aside className="w-72 bg-white border-r border-gray-200 overflow-y-auto">
          <div className="p-6 space-y-6">
            ...
            {/* Price Range */}
            <div>
              <h3 className="font-semibold text-sm mb-3 text-gray-900">Price Range (credits/hour)</h3>
            ...
            {/* Rating Filter */}
            <div>
              <h3 className="font-semibold text-sm mb-3 text-gray-900">Minimum Rating</h3>
              <div className="space-y-2">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                <p className="text-sm text-gray-600">
                  Showing <span className="font-semibold text-gray-900">{sortedSkills.length}</span> results
                  {selectedCategory !== 'all' && (
                    <span> in <span className="font-semibold text-gray-900">{skillCategories.find(c => c.id === selectedCategory)?.name}</span></span>
                  )}
                </p>
              </div>
            </div>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          {skill.badge && (
                            <Badge 
                              variant={skill.badge === 'Bestseller' ? 'default' : 'secondary'}
                              className="text-xs"
                            >
                              {skill.badge}
                            </Badge>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <span className="text-sm text-gray-500 ml-1">credits/hr</span>
                      </div>
                      <Button 
                        onClick={(e) => { 
                          e.stopPropagation(); 
